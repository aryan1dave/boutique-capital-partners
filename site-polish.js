...
(function () {
  ...
  var css = [
    ...
    /* ===== Responsive layer — overrides desktop inline styles on small screens ===== */
    "@media (max-width:820px){",
      ...
      "header>div{flex-wrap:wrap !important;gap:10px !important;row-gap:6px !important;}",
      "header nav ul{flex-wrap:wrap !important;column-gap:14px !important;row-gap:2px !important;justify-content:flex-start !important;}",
      "header nav a{font-size:15px !important;padding-top:6px !important;padding-bottom:6px !important;}",
      "header img{max-width:170px !important;height:auto !important;}",
      /* hero: stack instead of overlapping absolute cards */
      "[data-screen-label='Hero']{flex-direction:column !important;align-items:flex-start !important;justify-content:center !important;min-height:auto !important;padding-top:96px !important;padding-bottom:60px !important;}",
      "[data-screen-label='Hero'] [style*='bottom: 48px']{position:static !important;margin:34px 0 0 0 !important;left:auto !important;right:auto !important;bottom:auto !important;}",
      "[data-screen-label='Hero'] [style*='bottom: 48px']>a>div{width:100% !important;max-width:360px !important;}",
      "[data-screen-label='Hero'] [style*='bottom: 30px']{display:none !important;}",
    "}",
    "@media (max-width:600px){",
      "[style*='repeat(4']{grid-template-columns:1fr 1fr !important;}",
      "[style*='repeat(6']{grid-template-columns:1fr 1fr !important;}",
